...
APP_EXE ?= $(APP_PATH)/intersection/$(test-name)/$(APP_NAME).so
...
CXXFLAGS-binary-search := -DINTERSECTION_ALGORITHM_BINARY_SEARCH
CXXFLAGS-linear-search := -DINTERSECTION_ALGORITHM_LINEAR_SEARCH

CXXFLAGS += $(CXXFLAGS-$(algorithm))
