...
TESTS += $(call test-name,16,32,1,1,u12k16,0)
# TESTS += $(call test-name,16,32,1,1,u12k16,0)

#TESTS += $(call test-name,8,64,1,1,u12k16,0)
#TESTS += $(call test-name,8,64,2,1,u12k16,0)

# TESTS += $(call test-name,16,16,1,1,u12k16,0)

# TESTS += $(call test-name,1,1,1,1,u12k16,0)
# TESTS += $(call test-name,2,1,1,1,u12k16,0)
# TESTS += $(call test-name,4,1,1,1,u12k16,0)
# TESTS += $(call test-name,8,1,1,1,u12k16,0)
# TESTS += $(call test-name,16,1,1,1,u12k16,0)
