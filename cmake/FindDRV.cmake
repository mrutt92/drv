...
function (drvr_add_executable name)
  if (NOT DEFINED ARCH_RV64)
    ...
    if (NOT TARGET pandohammer)
      ...
      set_property(TARGET pandohammer PROPERTY IMPORTED_LOCATION ${DRV_BINARY_DIR}/pandohammer/lib/libpandohammer.a)
      set_property(TARGET pandohammer PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${DRV_BINARY_DIR}/pandohammer/include)
      set_property(TARGET pandohammer PROPERTY INTERFACE_LINK_OPTIONS -T ${DRV_BINARY_DIR}/pandohammer/lib/bsg_link.ld)
    endif()
